...
utförs i enighet med sektionens och THS stadgar.
...
Nämndens syfte är att främja manliga intressen på Datasektionen.

\subsubsection{Organisation}

Ordförande för NULL är Styvfar, som väljs på Val-SM.

\subsubsection{Verksamhet}

NULL ska verka för att ge medlemmar i datasektionen en möjlighet att umgås
under historiskt sett manliga omständigheter. Nämnden ska anordna en
pokerkvällar två gånger per år, en drinkprovning per år samt en whiskeyprovning
per år. Nämnden ska medverka under mottagningens arrangemang Herrpub.

\subsubsection{Styvfar}

Är ordförande för NULL. Väljs på Val-SM. Har läsår som mandatperiod.
...
I det fall att posten är vakantsatt har Konglig Öfverdrif ansvarar för bilen.
